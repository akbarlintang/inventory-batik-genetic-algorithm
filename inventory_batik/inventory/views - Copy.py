            ...
            for outlet in outlets:
                ...
                for item in items:
                    ...
                    product = {
                        ...
                        'biaya_pesan': item.biaya_pesan,
                        'permintaan_baku': total_sales,
                        'biaya_simpan': 20000,  # Static value as per your example
                        'biaya_kekurangan': round((item.price * 7.5 / 100) + item.price),
                        'harga_produk': item.price,
                    ...
                    first_c_hold = 2000 * ((first_S + first_s) / 2) + ((first_total_demand * first_R) / first_purchases_freq)
                    ...
                    c_hold = 2000 * round((best_S + best_s) / 2) + round((tot_demand * best_R) / purchases_freq)
